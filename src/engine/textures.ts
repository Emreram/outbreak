...
// The map itself now lives in shared/tilePalette.ts (renderer-neutral) so the
// Babylon path shares the exact palette; re-exported here for back-compat.
export { TILE_COLORS } from "../shared/tilePalette";
