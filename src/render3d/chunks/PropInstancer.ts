...
const PROPS: Record<string, PropSpec> = {
  ...
  car: { boxes: [box(1.3, 0.42, 2.4, 0x2a527d), box(1.1, 0.34, 1.2, 0x12202e, 0.42)] },
  wreck: { boxes: [box(1.3, 0.4, 2.4, 0x33352f), box(1.1, 0.3, 1.2, 0x24221b, 0.4)] },
  crate: { boxes: [box(0.7, 0.6, 0.7, 0xb5853f)] },
  barrel: { boxes: [box(0.5, 0.8, 0.5, 0x4f6a8a)] },
  dumpster: { boxes: [box(1.4, 0.9, 0.8, 0x3f6a46), box(1.42, 0.08, 0.82, 0x2c4a31, 0.9)] },
  shelf: { boxes: [box(1.0, 1.4, 0.4, 0x6e5230), box(0.9, 0.08, 0.34, 0xb7a23f, 0.6)] },
  bookshelf: { boxes: [box(1.0, 1.6, 0.35, 0x4a3c2d), box(0.9, 0.1, 0.3, 0xd1483a, 0.8)] },
